...
public class OutBuffer
{
  ...
  public synchronized void setDataSendSeq(int s){
	  dataSendSeq = s;
  }
  
  public synchronized void setDataBaseSeq(int s){
	  dataBaseSeq = s;
  }
  
  public synchronized void setDataStartSeq(int s){
	  dataStartSeq = s;
  }
  ...
  public synchronized long getDataStartSeq()
  {
    return dataStartSeq;
  }
