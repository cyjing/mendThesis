...
#define CLICK_BINDIR "/afs/csail.mit.edu/u/c/cyjing/mobilityFirst/bin/bin"

/* Install directory for Click libraries and packages. */
#define CLICK_LIBDIR "/afs/csail.mit.edu/u/c/cyjing/mobilityFirst/bin/lib"

/* Install directory for Click shared data. */
#define CLICK_DATADIR "/afs/csail.mit.edu/u/c/cyjing/mobilityFirst/bin/share/click"
