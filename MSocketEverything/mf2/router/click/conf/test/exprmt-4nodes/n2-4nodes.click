...
// eth0.1001 192.168.1.2 00:03:1d:0c:cd:b0
// eth0.1002 192.168.2.1 00:03:1d:0c:cd:b0

// Shared IP input path and routing table
ip :: Strip(14)
    -> CheckIPHeader(INTERFACES 192.168.1.2/255.255.255.0 192.168.2.1/255.255.255.0)
    -> rt :: StaticIPLookup(
	192.168.1.2/32 0,
	192.168.1.255/32 0,
	192.168.1.0/32 0,
	...
	192.168.2.0/255.255.255.0 192.168.2.2 2,
	192.168.3.0/255.255.255.0 192.168.2.2 2);
...
out0 :: Queue(65536) -> todevice0 :: ToDevice(eth0.1001);
c0[0] -> ar0 :: ARPResponder(192.168.1.2 00:03:1d:0c:cd:b0) -> out0;
...
c1[0] -> ar1 :: ARPResponder(192.168.2.1 00:03:1d:0c:cd:b0) -> out1;
