...
//L3 chunk sources
//chunk generator 
chk_src::MF_ChunkSource(SRC_GUID $src_GUID, DST_GUID $dst_GUID, SIZE $chk_size, LIMIT $chk_lmt, ROUTER_STATS routerstats, CHUNK_MANAGER chk_mngr, SERVICE_ID $service_id, PKT_SIZE $pkt_size, INTERVAL $chk_intval, DST_NA $dst_NAs, DELAY $delay, VARIATION $chk_size_variation); 
chk_snk::MF_ChunkSink(CHUNK_MANAGER chk_mngr);
...
svc_cla[2] -> Print(WARN_UNHANDLED_SVC_TYPE) -> chk_snk;

//Forwarding decisions: default routing

intra_lkup[0] -> segQ; //send chunk to next hop
intra_lkup[1] -> chk_snk;
intra_lkup[2] -> chk_snk; 
intra_lkup[3] -> Discard; 
...
//Outgoing data frame, resending data have higher priority
seg[0] -> outQ_data;
...
//StaticThreadSched(fd_core 0, inUnq 1, nbUnq 1, segUnq 1, swUnq 1, td_core 2, seg 2, chk_src 3, lp_hndlr 3, lsa_hndlr 3, rtg_tbl 3, g1Unq 3, g2Unq 3, gnrs_svc_sndr 3, gnrs_svc_lstnr 3);
StaticThreadSched(fd_core 0, inUnq 1, nbUnq 1, segUnq 2, swUnq 2, td_core 3, seg 4, chk_src 5, chk_mngr 6, lp_hndlr 6, lsa_hndlr 6, rtg_tbl 6, g1Unq 7, g2Unq 7, gnrs_svc_sndr 7, gnrs_svc_lstnr 7);
